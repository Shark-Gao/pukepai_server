...
const doudizhuAi_1 = require("../../ai/doudizhuAi");
// 创建卡牌
...
class webSocketDealCardsRouter {
    static getLandlordAiDecision(roomInfo, userId) {
        var _a, _b;
        const strategy = (0, doudizhuAi_1.getDoudizhuAiStrategy)(roomInfo === null || roomInfo === void 0 ? void 0 : roomInfo.robot_level);
        return strategy.shouldSelectLandlord(((_b = (_a = roomInfo === null || roomInfo === void 0 ? void 0 : roomInfo.roomUsers) === null || _a === void 0 ? void 0 : _a[userId]) === null || _b === void 0 ? void 0 : _b.user_card) || [], roomInfo, userId);
    }
    static autoSelectLandlord(roomId, snatchLandlordUserId) {
        const roomInfo = room_1.RoomObj[roomId];
        const roomUsers = roomInfo === null || roomInfo === void 0 ? void 0 : roomInfo.roomUsers;
        if (!roomUsers) {
            return;
        }
    ...
    static autoPassLandlord(roomId, snatchLandlordUserId) {
        const roomInfo = room_1.RoomObj[roomId];
        const roomUsers = roomInfo === null || roomInfo === void 0 ? void 0 : roomInfo.roomUsers;
        if (!roomUsers) {
            return;
    ...
    */
    ...
    static async grabLandlord(roomId, snatchLandlordUserId) {
        ...
        if ((_a = roomInfo.roomUsers[snatchLandlordUserId]) === null || _a === void 0 ? void 0 : _a.is_hosted) {
    ...
    async mingPai({ ws, token, userInfo, params }) {
        ...
        roomUserKeys.forEach(itemUserId => {
            // 明牌后所有玩家都可以看到全员真实手牌
            const newRoomUsers = (0, tools_1.clientReturnRoomUsers)(roomUsers, itemUserId, false);
            // 获取用户信息
            const ItemUserInfo = roomUsers[itemUserId];
            (0, webSocket_1.wsSend)(ItemUserInfo.ws, {
                type: "mingPai",
...
//# sourceMappingURL=webSocketDealCardsRouter.js.map